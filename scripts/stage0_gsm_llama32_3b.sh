...
#SBATCH --job-name=coco0_llama32_3b_gsm  # <-- MOFIDY
...
#SBATCH --gres=gpu:4  # <-- MODIFY
#SBATCH --constraint=VRAM_48GB  # <-- MODIFY
...
torchrun --nnodes 1 --nproc_per_node 4 run.py args/gsm_cot_llama.yaml
