...
#SBATCH --job-name=coco1_llama32_3b_prosqa_prob  # <-- MOFIDY
...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4 # <-- MODIFY
#SBATCH --mem=200G  # <-- MODIFY

#SBATCH --gres=gpu:1  # <-- MODIFY
...
torchrun --master_port 29501 --nnodes 1 --nproc_per_node 1 run.py args/prosqa_coconut_llama_prob.yaml
